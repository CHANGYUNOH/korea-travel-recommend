                    ...
                    <div className='detail-view'>
                        ...
                        <ul className='info-area'>
                            <li className='info-area-list'>
                                ...
                                <span className='cont'>경상북도 영덕군 병곡면 고래불로 12</span>
                            </li>
                            <li className='info-area-list'>
                            ...
                            <li className='info-area-list'>
                                <span className='tit'>캠핑장 유형</span>
                                <span className='cont'>일반야영장, 자동차야영장, 카라반</span>
                            </li>
                            <li className='info-area-list'>
                                <span className='tit'>운영기간</span>
                                <span className='cont'>봄, 여름, 가을, 겨울</span>
                            </li>
                            <li className='info-area-list'>
                                <span className='tit'>테마환경</span>
                                <span className='cont'>낚시, 여름, 물놀이</span>
                            </li>
                            <li className='info-area-list'>
                                <span className='tit'>운영일</span>
                                <span className='cont'>평일+주말</span>
                            </li>
                            <li className='info-area-list'>
                            ...
                            <li className='info-area-list'>
                                <span className='tit'>예약방법</span>
                                <span className='cont'>온라인실시간예약</span>
                            </li>
                            <li className='info-area-list'>
                                <span className='tit'>주변이용가능시설</span>
                                <span className='cont'>수상레저, 낚시, 해수욕</span>
                            </li>
                            <li className='info-area-list'>
                                <span className='tit'>애완동물출입</span>
                                <span className='cont'>불가능</span>
                            </li>
                        </ul>
